const audionContext = new AudioContext()
...
// add listeres to obeserve when a key is pressed down or up
 ...
 function getNoteDetail(keyboardKey) {
  ...
  function startNote(noteDetail, gain) {
    const gainNode = audionContext.createGain()
    gainNode.gain.value = gain
    const oscillator = audionContext.createOscillator()
    oscillator.frequency.value = noteDetail.frequency
    oscillator.type = "sine"
    oscillator.connect(audionContext.destination)
    oscillator.start()
